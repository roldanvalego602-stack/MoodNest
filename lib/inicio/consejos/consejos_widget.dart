...
class ConsejosWidget extends StatefulWidget {
  ...
  static String routeName = 'Consejos';
  static String routePath = '/consejos';
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      'Usa la vibración suave para calmar momentos de ansiedad. Puede ayudar a regular el sistema sensorial.',
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.all(4.0),
                                    child: Text(
                                      'Establezca horarios regulares para interactuar con el muñeco. La consistencia proporciona seguridad.',
                                      textAlign: TextAlign.start,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                                          .override(
                              ...
                              children: [
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsets.all(4.0),
                                    child: Text(
                                      'Use las emociones del muñeco para enseñar a identificar y expresar sentimientos de manera segura.',
                                      textAlign: TextAlign.start,
                                      style: FlutterFlowTheme.of(context)
                                          .headlineMedium
                                          .override(
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(PagenialoooWidget.routeName);
                    },
                    text: 'Button',
