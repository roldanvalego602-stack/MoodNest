            ...
            children: [
              Align(
                ...
                child: Padding(
                  ...
                  child: Text(
                    'Escribe aquí para una nueva nota',
                        ...
                        child: Align(
                          ...
                          child: TextFormField(
                            ...
                            onChanged: (_) => EasyDebounce.debounce(
                              ...
                              () async {
                                _model.notaTexto = _model.textController.text;
                                safeSetState(() {});
                              },
                            ),
                            autofocus: false,
              ...
              Align(
                alignment: AlignmentDirectional(0.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 30.0, 0.0, 6.0),
                  child: FFButtonWidget(
                    onPressed: () async {
                      await NotasRecord.collection.doc().set({
                        ...createNotasRecordData(
                          textto: _model.textController.text,
                        ),
                        ...mapToFirestore(
                          {
                            'tiempotexto': FieldValue.serverTimestamp(),
                          },
                        ),
                      });
                      context.safePop();
              ...
              Align(
                alignment: AlignmentDirectional(0.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(0.0, 10.0, 0.0, 46.0),
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.safePop();
                    },
