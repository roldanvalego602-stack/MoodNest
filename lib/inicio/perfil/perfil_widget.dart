              ...
              children: [
                Align(
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      'Información del niño y configuración de la aplicación',
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(EditarWidget.routeName);
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [Color(0xFFF1FBFA), Color(0xFFCDFAC2)],
                        stops: [0.0, 1.0],
                        begin: AlignmentDirectional(0.0, -1.0),
                        end: AlignmentDirectional(0, 1.0),
                      ),
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    gradient: LinearGradient(
                                      ...
                                      stops: [0.0, 1.0],
                                      begin: AlignmentDirectional(1.0, 0.31),
                                      end: AlignmentDirectional(-1.0, -0.31),
                                    ),
                                    shape: BoxShape.circle,
                                  ),
                                  child: Icon(
